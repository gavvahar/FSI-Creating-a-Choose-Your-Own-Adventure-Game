...
} else if(firstAnswer === 'right')
{
  ...
  {
    let thirdAnswer = window.prompt('The dragon wakes up and sits upright. You only have a moment to respond, to stauu or run')
    if(thirdAnswer === 'stay')
    {
  ...
  {
    let thirdAnswer = window.prompt('After walking a while longer, you com across a shiny blue flower. It is so beautiful that you decide ou must either draw it or pick it. Which do you do?')
    if(thirdAnswer === 'draw it')
    {
      window.alert('You draw the flower, capturing only a fraction of its beauty with your quil. You bring the drawing home, somewhat disappointed recounting the story of your days as a sorcerer with the aid of the sketch.')
    } else
    {
